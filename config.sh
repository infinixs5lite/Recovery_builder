...
# about your device
export DEVICE="gale" # codename used in device tree
export DT_LINK="https://github.com/infinixs5lite/recovery_device_xiaomi_gale-TWRP_UPDATE" # device tree link
export DT_BRANCH="A14" # device tree branch
